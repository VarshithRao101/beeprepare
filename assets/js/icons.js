...
export const getNavIcon = (name, isActive = false) => {
    ...
    const fill = isActive ? 'rgba(255, 192, 0, 0.2)' : 'none';

    const paths = {
        'Home': '<path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline>',
        'Bank': '<rect x="2" y="7" width="20" height="14" rx="2" ry="2"></rect><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"></path>',
...
const getSubjectPath = (subjectName) => {
    ...
    if (name.includes('physics')) {
        return '<path d="M12 2a10 10 0 1 0 10 10 4 4 0 0 1-5-5 4 4 0 0 1-5-5"></path><path d="M8.5 8.5a4 4 0 1 1 5.6 5.6"></path>';
    }
